...
public class QSlot implements Slot {
    ...
    private QSlot(@NotNull Builder builder) {
    ...
    public static QSlot of(@NotNull Consumer<Builder> builder) {
        Preconditions.checkNotNull(builder, "Builder cannot be null");
        Builder newBuilder = new Builder();
        builder.accept(newBuilder);
        return new QSlot(newBuilder);
    }

    @Override
    public QSlot modifyDisplayName(Component displayName) {
        this.itemStack.setData(DataComponentTypes.ITEM_NAME, displayName);
        return this;
    }

    @Override
    public QSlot modifyLore(ItemLore lore) {
